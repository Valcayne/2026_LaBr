...
#define TREENAME "LABR" // "LABR" de-activates reading CutList. Other options: "BAF2"
#define NDETECTORS 13 // 40
const string ROOTFILEFOLDER = "~/myWindows/cernbox/2026_Sm_EAR1/processed_rootfiles"; 
...
//  #define CUTFILENAME 11 // It MEANS  sprintf(cutlistname,"/home/u6979/CmMeasurement/Functions/AnalysisTAC/PulseDiscrimination/CutList0%d.txt",CutFileNumber);
//
